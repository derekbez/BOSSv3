"""Tests for hardware factory selection."""
...
def test_mock_factory_does_not_mutate_config(monkeypatch):
    """Factory no longer sets dev_mode; that's the caller's responsibility."""
    cfg = BossConfig()
    ...
    # Factory must NOT mutate config — dev_mode stays at its default
